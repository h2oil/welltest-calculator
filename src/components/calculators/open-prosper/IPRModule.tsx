              ...
              {iprResult ? (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-muted rounded-lg">
                      <div className="text-2xl font-bold">{iprResult?.max_rate ? Number(iprResult.max_rate.toFixed(1)) : 'N/A'}</div>
                      <p className="text-sm text-muted-foreground">Max Rate ({getFlowRateUnit()})</p>
                    </div>
                    <div className="p-4 bg-muted rounded-lg">
                      <div className="text-2xl font-bold">{iprResult?.max_pressure ? Number(iprResult.max_pressure.toFixed(0)) : 'N/A'}</div>
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart
                          data={iprResult.rates.map((rate, index) => ({
                            ...
                            pressure: Number(iprResult?.pressures?.[index]?.toFixed(0)) || 0,
                            name: `Point ${index + 1}`
                          }))}
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    <p className="text-sm text-green-700">
                      ...
                      Maximum flow rate: {iprResult?.max_rate ? Number(iprResult.max_rate.toFixed(1)) : 'N/A'} {getFlowRateUnit()}
                    </p>
                  </div>
                </div>
              ) : (
